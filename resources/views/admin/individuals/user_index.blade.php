...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        @if(Request::is('admin/individuals/user/active'))
            ...
            <!-- START BASIC TABLE SAMPLE -->
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="/admin/individual/user/create">
                          <button type="button" class="btn btn-info">
                            <i class="fa fa-plus"></i>
                            {{ __('language.New User') }}
                          </button>
                        </a>
                    </div>
...
{{--                                        <td>{{$tech->badge_id}}</td>--}}
                                        ...
                                        <td>{{$user->phone}}</td>
                                        <td>
                                            <img src="/individuals/{{$user->image}}" class="image_radius"/>
                                        </td>
                                        <td>
                                            <a title="View admin" href="/admin/individual/user/{{$user->id}}/view"><button class="btn btn-info btn-condensed"><i class="fa fa-eye"></i></button></a>
                                            <a title="Edit" href="/admin/individual/user/{{$user->id}}/edit"><button class="btn btn-warning btn-condensed"><i class="fa fa-edit"></i></button></a>
                                            @if($user->active == 1)
