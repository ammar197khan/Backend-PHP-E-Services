...
@section('content')
    ...
    <script>
        $(document).ready(function () {
            var company_parent_id = {{request('company_id')[0]?request('company_id')[0]:''}}

                company_parent_id ?
                $.ajax({
                    url: '/admin/get_sub_company/'+company_parent_id,
                    type: "GET",
                    dataType: "json",
            ...
            var main_parent_id = {{request('main_cats')[0]?request('main_cats')[0]:''}}

                main_parent_id ?
                $.ajax({
                    url: '/admin/get_sub_cats/' + main_parent_id,
                    type: "GET",
            ...
            var sub_parent_id = {{request('sub_cats')[0]?request('sub_cats')[0]:''}}

            sub_parent_id ?
                $.ajax({
                    url: '/admin/get_sub_cats/'+sub_parent_id,
                    type: "GET",
