                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th class="text-center">{{ __('language.Amount') }}</th>
                                ...
                                <tr>
                                    ...
                                    @if(count($order->details) > 0)
                                        @foreach($order->details as $detail)
                                            ...
                                            isset($detail->cat_fee($order->provider_id,$company_ids,$detail->type_id)->third_fee) ?
                                            $detail->cat_fee($order->provider_id,$company_ids,$detail->type_id)->third_fee : 0}}</td>
                                            <td class="text-center">{{
