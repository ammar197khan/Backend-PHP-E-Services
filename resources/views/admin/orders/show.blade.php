                    ...
                    <div class="panel-body">
                        <div>
                            <div class="col-md-6">
                                ...
                                @endif
                                <h3>{{ __('language.Service Category') }} : {{$order->category->parent->en_name}} - {{$order->category->en_name}} </h3>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="invoice-address">
                                        ...
                                        <h6>{{ __('language.Company') }}: <a target="_blank" href="/admin/company/{{$order->user->company->id}}/view">{{$order->user->company->en_name}}</a> - {{optional($order->user->sub_company)->en_name}}</h6>
                                        <p>{{ __('language.Name') }}: <a target="_blank" href="/admin/company/user/{{$order->user->id}}/view">{{$order->user->en_name}}</a></p>
                                ...
                                <div class="col-md-3">
                                    <div class="invoice-address">
                                        ...
                                        @if(isset($order->tech_id))
                                            <h6>{{ __('language.Provider') }}: <a target="_blank" href="/admin/provider/{{$order->tech->provider->id}}/view">{{$order->tech->provider->en_name}}</a></h6>
                                            <p>{{ __('language.View Technician') }}: <a target="_blank" href="/admin/provider/technician/{{$order->tech->id}}/view">{{$order->tech->en_name}}</a></p>
                                    ...
                                    <table class="table-responsive">
                                      ...
                                      @foreach ($order->ItemsRequireUserApproval() as $item)
                                        <tr>
                                          ...
                                          <td>{{ $item->price }}</td>
                                          <td>{{ $item->taken }}</td>
                                          <td><span class="label label-warning">{{ __('language.Require User Approval') }}</span></td>
