...
if($provider->type == 'cash'){
    ...
    $subTotal = $provider->commissionValue($data['total_count_orders']) / 100 * $data['order_sum_total'];
      ...
      <section style="margin-inline: 20px;">
          ...
          text-align: center;">
              ...
              {{-- <ng-container  *ngFor="let row of printData.pmsgrnInvoiceDetails; let i = index"> --}}
                 @if(!empty($data['adminInvoiceDetail']))
                @foreach ($data['adminInvoiceDetail'] as $order)
              ...
              <tr>
                ...
                <td style="border: 1px solid #5a5959;">{{ !empty($order['rate'])? $order['rate'] : '' }}</td>
                <td style="border: 1px solid #5a5959;">{{ !empty($order['qty_rate_total'])? $order['qty_rate_total'] : '' }}</td>
              </tr>
              @endforeach
              @endif
              {{-- </ng-container> --}}
              <tr style="font-size: 10px;">
                ...
                <tr style="font-size: 10px;">
                    ...
                    <td style="border: 1px solid #5a5959;text-align: right; padding-right: 2px;" >
                        {{ !empty($data['order_sum_total'])? $data['order_sum_total']: '' }} SAR
                    </td>
                </tr>
