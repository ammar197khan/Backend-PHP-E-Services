...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Edit privacy text</li>
    </ul>
    <!-- END BREADCRUMB -->
    {{--{{dd($errors)}}--}}
    <div class="page-content-wrap">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" action="/admin/settings/privacy/update" method="post">
                    {{csrf_field()}}
                        ...
                        <div class="panel-body">
                            <div class="form-group {{ $errors->has('en_text') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control summernote" name="en_text" rows="10">{{$privacy->en_text }}</textarea>
                                    </div>
                            ...
                            <div class="form-group {{ $errors->has('ar_text') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-file-text"></span></span>
                                        <textarea class="form-control summernote" name="ar_text" rows="10">{{$privacy->ar_text }}</textarea>
                                    </div>
