        ...
        <div class="row">
            ...
            <!-- START BASIC TABLE SAMPLE -->
                <div class="panel panel-default">
                    ...
                    {{--<input type="text" class="form-control" name="search" value="{{isset($search) ? $search : ''}}" placeholder="Search by SMO No. or Order No. or technician badge_id,name" style="margin-top: 1px;"/>--}}
                            ...
                            <table class="table">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <a title="{{ __('language.View') }}" href="/company/order/{{$order->id}}/view"><button class="btn btn-info btn-condensed"><i class="fa fa-eye"></i></button></a>
