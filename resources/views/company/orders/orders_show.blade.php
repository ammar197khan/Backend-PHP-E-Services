                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="btn-group pull-left">
                                <h2><span class="fa fa-wrench"> {{$type_value}} {{ __('language.Orders') }}</span></h2>
                            ...
                            <table class="table">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            @if(isset($order->id))
                                                <a title="{{ __('language.View Order') }}" href="/company/order/{{$order->id}}/view"><button class="btn btn-info btn-condensed"><i class="fa fa-eye"></i></button></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
