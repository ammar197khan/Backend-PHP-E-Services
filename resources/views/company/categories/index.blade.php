        ...
        <div class="row">
            ...
            <!-- START BASIC TABLE SAMPLE -->
                <div style="height:auto" class="panel panel-default">
                    ...
                    <a href="/company/categories" class="btnprn pull-right" style="font-size: 20px; padding-right: 10px; text-decoration:none"> <i class="fa fa-print"></i> PRINT</a>
                    <script>
                        $(document).ready(function () {
                            $('.btnprn').printPage();
                        });
                    </script>
                    <form class="form-horizontal" method="get" action="/company/categories/search">
