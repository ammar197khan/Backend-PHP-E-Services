...
@section('content')
    <!-- START BREADCRUMB -->
    <ul class="breadcrumb">
        <li><a href="/provider/collaboration/{{$id}}/statistics">{{ __('language.Dashboard') }}</a></li>
        ...
        <div class="row">
            ...
            <!-- START BASIC TABLE SAMPLE -->
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal" method="get" action="/provider/collaboration/{{$id}}/statistics/{{$type}}/search">
                            ...
                            <table class="table">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <a title="View" href="/provider/collaboration/{{$id}}/order/{{$order->id}}/view"><button class="btn btn-info btn-condensed"><i class="fa fa-eye"></i></button></a>
