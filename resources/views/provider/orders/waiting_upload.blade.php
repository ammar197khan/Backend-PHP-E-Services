    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" method="post" action="/provider/orders/open/waiting/upload" enctype="multipart/form-data">
                    {{csrf_field()}}
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group {{ $errors->has('file') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    @include('provider.layouts.error', ['input' => 'smo'])
                                    @include('provider.layouts.error', ['input' => 'type'])
                                    @include('provider.layouts.error', ['input' => 'company_id'])
                                    @include('provider.layouts.error', ['input' => 'provider_id'])
                                    @include('provider.layouts.error', ['input' => 'service_type'])
                                    @include('provider.layouts.error', ['input' => 'cat_id'])
                                    @include('provider.layouts.error', ['input' => 'tech_id'])
                                    @include('provider.layouts.error', ['input' => 'user_id'])
                                    @include('provider.layouts.error', ['input' => 'place'])
                                    @include('provider.layouts.error', ['input' => 'part'])
